...
public interface ProgramListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ProgramParser#varI}.
	 * @param ctx the parse tree
	 */
	void enterVarI(ProgramParser.VarIContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProgramParser#varI}.
	 * @param ctx the parse tree
	 */
	void exitVarI(ProgramParser.VarIContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ProgramParser#sExpr}.
	 * @param ctx the parse tree
	 */
	void enterSExpr(ProgramParser.SExprContext ctx);
	/**
	 * Exit a parse tree produced by {@link ProgramParser#sExpr}.
	 * @param ctx the parse tree
	 */
	void exitSExpr(ProgramParser.SExprContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ProgramParser#exprW2}.
	 * @param ctx the parse tree
	 */
	void enterExprW2(ProgramParser.ExprW2Context ctx);
	/**
	 * Exit a parse tree produced by {@link ProgramParser#exprW2}.
	 * @param ctx the parse tree
	 */
	void exitExprW2(ProgramParser.ExprW2Context ctx);
	/**
